...
lista = list()
aa = a.split("=")
for x in range(int(aa[1])):
    lista.append(a.split("=")[0])
print(lista)
...
import random
random.choices(lista,k=2)


# In[ ]:


list1 = ["rojo", "rojo", "verde", "verde", "azul"]
list2 =  ["azul", "rojo", "verde", "verde", "rojo"]
...
for x in expected_balls.values():
    for i in range(x):
        auxlist.append(list(expected_balls)[index])
    index+= 1
